...
def msg( window, text, pos, color=( 255,255,255 ), size=25, bold=0, italic=0, centered=False, align_to_screen=False, background=( ( 0,0,0 ), 0 ), weight=-1 ):
	...
	if weight == 1:
		...
		if not align_to_screen:
			...
			if centered:
				...
				window.blit( label, [ pos[ 0 ] - rect[ 2 ], pos[ 1 ] ] )
